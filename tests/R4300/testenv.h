...
using Vector = Dynarmic::R4300::Vector;

class R4300TestEnv : public Dynarmic::R4300::UserCallbacks {
public:
    u64 ticks_left = 0;
    ...
    void ExceptionRaised(u64 pc, Dynarmic::R4300::Exception /*exception*/) override { ASSERT_MSG(false, "ExceptionRaised({:016x})", pc); }
...
class R4300FastmemTestEnv final : public Dynarmic::R4300::UserCallbacks {
public:
    u64 ticks_left = 0;
    char* backing_memory = nullptr;

    explicit R4300FastmemTestEnv(char* addr)
            : backing_memory(addr) {}
    ...
    void ExceptionRaised(u64 pc, Dynarmic::R4300::Exception) override { ASSERT_MSG(false, "ExceptionRaised({:016x})", pc); }
